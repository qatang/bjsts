package com.bjsts.core.component.postgresql.usertype;
...
public class JsonbPGUserType implements ParameterizedType, UserType {
    ...
    public Object nullSafeGet(ResultSet resultSet, String[] names, SessionImplementor session, Object owner) throws
        ...
        try {
            ...
            return json == null ? null : getObjectMapper().readValue(json, jsonClassType);
        } catch (IOException e) {
    ...
    public void nullSafeSet(PreparedStatement st, Object value, int index, SessionImplementor session) throws
            HibernateException, SQLException {
        try {
            final String json = value == null ? null : getObjectMapper().writeValueAsString(value);
