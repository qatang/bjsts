...
import com.bjsts.manager.form.stock.OutBoundForm;
import com.bjsts.manager.query.stock.OutBoundSearchable;
import com.bjsts.manager.service.stock.OutBoundService;
...
public class OutBoundController extends AbstractController {
    ...
    public String create(OutBoundForm outBoundForm, BindingResult result, RedirectAttributes redirectAttributes) {
        ...
        String planNo = outBoundEntity.getPlanNo();

        if (StringUtils.isEmpty(planNo) || planNo.equals("0")) {
